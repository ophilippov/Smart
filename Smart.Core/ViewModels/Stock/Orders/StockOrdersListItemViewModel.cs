...
namespace Smart.Core { 
    ...
    /// <summary>
    /// The class that provides data which <see cref="StockOrdersListItemControl"> can display
    /// </summary>
    public class StockOrdersListItemViewModel:BaseViewModel
    {
        ...
        /// </summary>
        private static StockOrdersListItemViewModel mCurrentlySelectedOrderItem = null;
        ...
        /// Default constructor
        /// </summary>
        public StockOrdersListItemViewModel()
        {
            //Initialize commands
            ...
            IoC.Stock.CurrentOrderNumberNullChanged += Unselect;
        }
        #endregion
        ...
        private void Select()
        {
            ...
            if (Int32.TryParse(OrderNumber, out int orderNumber))
            {
                ...
                IoC.Stock.CurrentOrderNumber = orderNumber;
        ...
        private void OpenOrder()
        {
            ...
            IoC.Stock.InfoOrderCommand.Execute(null);
